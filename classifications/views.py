...
class ClassificationDetailView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        classification_results_prefetch = Prefetch(
            ...
            queryset=ClassificationResult.objects.all().select_related("runner"),
        )
        context["results"] = (
            Classification.objects.prefetch_related(classification_results_prefetch)
            .get(id=classification.id)
